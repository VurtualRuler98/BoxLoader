params [["_veh",objNull,[objNull]],["_obj","",[""]],["_rot",0,[0]]];
...
if (hasInterface) then {
	...
	_veh addAction ["Select container loading target",{(_this select 1) setVariable["boxloader_tgt",((_this select 0) getVariable["boxloader_mem",objNull]),true];},[],0,false,true,"","(vehicle _this == _this) && (isNull (_this getVariable 'boxloader_tgt'))"];
};
