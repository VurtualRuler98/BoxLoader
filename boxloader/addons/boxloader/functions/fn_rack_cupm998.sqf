...
if (!(_veh isKindOf "CUP_HMMWV_Transport_Base")) exitWith {["That's not the right vehicle for the cargo mode!"] call bis_fnc_error; false};
...
_rack0 = "Land_Boxloader_mem_cupm998" createVehicle position _veh;
_rack0 attachTo [_veh,[0,-1.05,-0.59]];
