...
if (!(_veh isKindOf "CUP_M1152_BASE")) exitWith {["That's not the right vehicle for the cargo mode!"] call bis_fnc_error; false};
...
_rack0 = "Land_Boxloader_mem_cupm1152" createVehicle position _veh;
_rack0 attachTo [_veh,[0,-1.3,-1.54]];
