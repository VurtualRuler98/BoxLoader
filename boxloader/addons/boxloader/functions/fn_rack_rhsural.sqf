...
if (!(_veh isKindOf "RHS_Ural_Flat_MSV_01") && !(_veh isKindOf "RHS_Ural_Open_Flat_MSV_01")) exitWith {["That's not an acceptable RHS URAL!"] call bis_fnc_error; false};
...
_rack0 attachTo [_veh,[0,-1.4,-0.18]];
