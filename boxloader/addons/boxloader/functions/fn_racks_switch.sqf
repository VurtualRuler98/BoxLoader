...
if (!((_rack call boxloader_fnc_racks_validate) select 0)) exitWith {["Variable passed is not rack data!"] call bis_fnc_error; false}; //You sent something that wasn't rack data
