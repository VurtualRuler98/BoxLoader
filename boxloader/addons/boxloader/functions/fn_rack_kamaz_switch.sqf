...
if (!(_veh isKindOf "Truck_02_transport_Base_F") && (!(typeOf _veh in ["O_Truck_02_covered_F","I_Truck_02_covered_F","C_Truck_02_covered_F","C_IDAP_Truck_02_F"]) || (_veh isKindOf "rhs_kamaz5350"))) exitWith {["That's not an acceptable kamaz!"] call bis_fnc_error; false};
